...
include_once "includes/requestaccount.inc.php";
?>
	<div class="row">
		<div class="col-md-12">
			<?php display_message(); ?>
	...
	<div class="row">
		<div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
			<form role="form" method="post" name="registration_form">
				...
				<hr class="colorgraph">
				<div class="row">
					<div class="col-xs-12 col-md-6"><input type="submit" href="login.php" name="submit" value="Submit" class="btn btn-primary btn-block btn-lg" tabindex="7"></div>
