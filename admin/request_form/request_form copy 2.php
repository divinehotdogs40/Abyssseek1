...
<head>
    ...
    .swiper .container {
        ...
        .swiper-slide {
            ...
            margin: 10px; /* Adjust the margin to reduce spacing between slides */
            padding: 10px; /* Optional: Adjust padding as needed */
            transition: transform 0.3s ease;
            opacity: 0.5; /* Reduced opacity for non-centered slides */
        }
        ...
        .swiper-slide-prev,
        .swiper-slide-next {
            opacity: 0.5; /* Reduced opacity for previous and next slides */
        }

        .swiper-slide-prev {
            transform: translateX(-50%) scale(0.8) rotate(-10deg); /* Adjust rotation and scaling for previous slide */
        }

        .swiper-slide-next {
            transform: translateX(50%) scale(0.8) rotate(10deg); /* Adjust rotation and scaling for next slide */
        }
...
<script>
    var swiper = new Swiper('.swiper-container', {
        ...
        effect: 'circular', // Choose the effect for circular motion
        circular: {
            slideShadows: true, // Disable slide shadows for cube effect
        },
        pagination: {
            el: '.swiper-pagination',
            clickable: true,
