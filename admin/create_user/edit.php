...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE created_account SET Email='$Email', Password='$hashed_password', First_Name='$First_Name', Last_Name='$Last_Name', Position='$Position', Phone_Number='$Phone_Number' WHERE ID = $ID";
